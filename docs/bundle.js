...
function getTopWord(){
  __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
    ...
    success: function(word){
      ...
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".word-count").html(`<h3>${top_word}<br>count:${word.word[top_word]}</h3>`)}
  })
}
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(() => {
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()( "#break-down" ).on("click", function(){
    splitWords();
  })
})
